...
export async function GET(
    ...
    try {
        ...
        return NextResponse.json({
            ...
            projectType: details.project.projectType ?? "app",
            ...
            slidesSources: details.project.slidesSources ?? [],
            slidesWebSearchEnabled: details.project.slidesWebSearchEnabled ?? false,
            slidesStatus: details.project.slidesStatus ?? (details.project.projectType === "slides" ? "reading_sources" : undefined),
            slidesDeckStory: details.project.slidesDeckStory,
            slidesDeck: details.project.slidesDeck,
